...
// Routes
router.post('/', auth_1.auth, createCVValidation, validateRequest_1.validateRequest, cvController_1.createCV);
router.get('/', auth_1.auth, cvController_1.getUserCVs);
router.get('/:id', auth_1.auth, [(0, express_validator_1.param)('id').isMongoId()], validateRequest_1.validateRequest, cvController_1.getCVById);
router.put('/:id', auth_1.auth, updateCVValidation, validateRequest_1.validateRequest, cvController_1.updateCV);
router.delete('/:id', auth_1.auth, [(0, express_validator_1.param)('id').isMongoId()], validateRequest_1.validateRequest, cvController_1.deleteCV);
router.put('/:id/share', auth_1.auth, [
    (0, express_validator_1.param)('id').isMongoId().withMessage('Invalid CV ID'),
    (0, express_validator_1.body)('isPublic').isBoolean().withMessage('isPublic must be a boolean')
], validateRequest_1.validateRequest, cvController_1.shareCV);
