  ...
  const generateSkillSuggestions = async () => {
    ...
    try {
      ...
      const newSkills = suggestions
        .filter(suggestion => !existingSkillNames.includes(suggestion.toLowerCase()))
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mb-6">
          Add your technical and soft skills. Use AI to get personalized skill suggestions based on your profession.
        </p>
      </div>
      ...
      {skills.length === 0 && (
        <div className="text-center py-8">
          ...
          <p className="text-gray-600 mb-4">Add your skills manually or use AI suggestions</p>
        </div>
      )}
    </div>
  );
