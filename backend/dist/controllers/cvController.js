...
exports.getSharedCV = exports.shareCV = exports.deleteCV = exports.updateCV = exports.getCVById = exports.getUserCVs = exports.createCV = void 0;
...
const updateCV = async (req, res) => {
    try {
        ...
        if (data)
            cv.data = data;
        if (profession)
            cv.profession = profession.trim();
        if (atsScore !== undefined)
            cv.atsScore = atsScore;
        await cv.save();
        res.json({
            success: true,
