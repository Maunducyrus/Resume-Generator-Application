...
exports.generateSkillSuggestions = exports.optimizeForJob = exports.calculateATSScore = exports.generateInterviewQuestions = exports.generateCoverLetter = exports.optimizeExperience = exports.generateSummary = void 0;
...
const generateSummary = async (req, res) => {
    try {
        ...
        const summary = await openaiService_1.OpenAIService.generateProfessionalSummary(personalInfo, workExperience, profession || 'Professional');
        res.json({
            success: true,
            data: { summary }
        });
...
const optimizeExperience = async (req, res) => {
    try {
        ...
        const optimizedExperience = await openaiService_1.OpenAIService.optimizeWorkExperience(experience, profession || 'Professional');
        res.json({
            success: true,
...
const generateCoverLetter = async (req, res) => {
    try {
        ...
        const coverLetter = await openaiService_1.OpenAIService.generateCoverLetter(cvData, jobDescription, profession || 'Professional');
        res.json({
            success: true,
            data: { coverLetter }
        });
...
const generateInterviewQuestions = async (req, res) => {
    try {
        ...
        const questions = await openaiService_1.OpenAIService.generateInterviewQuestions(profession, jobDescription, experienceLevel);
        res.json({
            success: true,
            data: { questions }
        });
...
const calculateATSScore = async (req, res) => {
    try {
        ...
        const result = await openaiService_1.OpenAIService.calculateATSScore(cvData, profession || 'Professional');
        res.json({
            success: true,
            data: result
        });
...
const optimizeForJob = async (req, res) => {
    try {
        ...
        const optimization = await openaiService_1.OpenAIService.optimizeForJob(cvData, jobDescription, profession || 'Professional');
        res.json({
            success: true,
            data: optimization
        });
...
const generateSkillSuggestions = async (req, res) => {
    try {
        ...
        const skills = await openaiService_1.OpenAIService.generateSkillSuggestions(profession, experience || []);
        res.json({
            success: true,
            data: { skills }
        });
