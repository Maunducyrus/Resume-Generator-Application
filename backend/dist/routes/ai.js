...
router.post(
  ...
  [
    ...
    (0, express_validator_1.body)("workExperience")
      .isArray()
  ...
  aiController_1.generateSummary,
);
...
router.post(
  ...
  validateRequest_1.validateRequest,
  aiController_1.optimizeExperience,
);
// Generate cover letter
router.post(
  "/generate-cover-letter",
  [
    (0, express_validator_1.body)("cvData")
      .notEmpty()
  ...
  validateRequest_1.validateRequest,
  aiController_1.generateCoverLetter,
);
...
router.post(
  ...
  validateRequest_1.validateRequest,
  aiController_1.generateInterviewQuestions,
);
// Calculate ATS score
router.post(
  "/calculate-ats-score",
  ...
  validateRequest_1.validateRequest,
  aiController_1.calculateATSScore,
);
...
router.post(
  ...
  validateRequest_1.validateRequest,
  aiController_1.generateSkillSuggestions,
);
